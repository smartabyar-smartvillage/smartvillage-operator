...
# computateorg/smartvillage-operator-bundle:$VERSION and computateorg/smartvillage-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= computateorg/smartvillage-operator
